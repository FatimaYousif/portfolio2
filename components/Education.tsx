...
function Education({ post, company, dateStart, dateEnd, children }: EducationProps) {
  return (
    <>
      <RevealContent style="flex flex-col md:flex-row md:gap-6 gap-1 bg-lightSecondary-300 dark:bg-[#163E6C] shadow-lightCard dark:shadow-darkCard rounded-xl p-6 sm:p-8 md:p-10 lg:w-10/12 self-center">
        <>
          <div className="flex text-lightPrimary-700 dark:text-darkPrimary-700 flex-none">{dateStart} - {dateEnd ? dateEnd : "  Present"}</div>
